module ARM.MRAS.DTD.AArch32.Allinstrs where
...
data Allinstrs = Allinstrs Allinstrs_Attrs Title
               ...
               deriving (Eq,Show)
data Allinstrs_Attrs = Allinstrs_Attrs
    { allinstrsId :: String
...
data Box_Attrs = Box_Attrs
    { boxHibit :: (Maybe String)
    , boxName :: (Maybe String)
    , boxUsename :: (Maybe String)
...
data Brief_synth = Brief_synth_single  |  Brief_synth_multiple
                 deriving (Eq,Show)
...
data Encodingindex = Encodingindex Encodingindex_Attrs
                   ...
                   deriving (Eq,Show)
data Encodingindex_Attrs = Encodingindex_Attrs
    { encodingindexInstructionset :: String
    } deriving (Eq,Show)

data Groups = Groups Groups_Attrs Maintable
            deriving (Eq,Show)
data Groups_Attrs = Groups_Attrs
    { groupsHeading :: String
    } deriving (Eq,Show)

data Funcgroupheader = Funcgroupheader Funcgroupheader_Attrs String
                     deriving (Eq,Show)
data Funcgroupheader_Attrs = Funcgroupheader_Attrs
    { funcgroupheaderId :: String
    } deriving (Eq,Show)
...
data Explanation_intro = Explanation_intro Explanation_intro_Attrs
                                           [Explanation_intro_]
                       deriving (Eq,Show)
data Explanation_intro_Attrs = Explanation_intro_Attrs
    { explanation_introHeadingsabove :: String
    } deriving (Eq,Show)
...
data Explanation_Attrs = Explanation_Attrs
    { explanationEnclist :: (Maybe String)
...
data Instructiontable = Instructiontable Instructiontable_Attrs
                      ...
                      deriving (Eq,Show)
data Instructiontable_Attrs = Instructiontable_Attrs
...
data Iclass_sect = Iclass_sect Iclass_sect_Attrs Regdiagram
                               Instructiontable
                 deriving (Eq,Show)
data Iclass_sect_Attrs = Iclass_sect_Attrs
    { iclass_sectId :: String
...
data Iform = Iform Iform_Attrs String
           deriving (Eq,Show)
data Iform_Attrs = Iform_Attrs
    { iformId :: String
    , iformIformfile :: String
    , iformHeading :: String
    } deriving (Eq,Show)

data Iforms = Iforms Iforms_Attrs (List1 Iform)
            deriving (Eq,Show)
data Iforms_Attrs = Iforms_Attrs
    { iformsTitle :: String
    } deriving (Eq,Show)
...
data Instructionsection_Attrs = Instructionsection_Attrs
    ...
    , instructionsectionType :: Instructionsection_type
    } deriving (Eq,Show)
...
data Maintable = Maintable Maintable_Attrs [Col] Tableheader
                           Tablebody
               deriving (Eq,Show)
data Maintable_Attrs = Maintable_Attrs
    { maintableSize :: (Maybe Maintable_size)
    , maintableHowmanybits :: (Maybe String)
    , maintableClass :: (Maybe Maintable_class)
    } deriving (Eq,Show)

data Maintable_size = Maintable_size_16x2  |  Maintable_size_32
                    deriving (Eq,Show)
...
data Maintablesect = Maintablesect
    { maintablesectSect :: String
    , maintablesectLinkref :: (Maybe String)
    } deriving (Eq,Show)

newtype Para = Para String 		deriving (Eq,Show)
...
data Regdiagram_form = Regdiagram_form_16x2  |  Regdiagram_form_32
                     deriving (Eq,Show)
...
newtype Tablebody = Tablebody [Tablebody_] 		deriving (Eq,Show)

data Tablebody_ = Tablebody_ [Maintablesect] (List1 Tr)
                deriving (Eq,Show)

newtype Tableheader = Tableheader (List1 Tr) 		deriving (Eq,Show)

data Td = Td Td_Attrs [Td_]
        deriving (Eq,Show)
data Td_Attrs = Td_Attrs
    { tdColspan :: (Maybe String)
    , tdRowspan :: (Maybe String)
    , tdClass :: (Maybe String)
    , tdIformid :: (Maybe String)
    , tdBitwidth :: (Maybe String)
    , tdNote :: (Maybe String)
    , tdIngroup :: (Maybe Td_ingroup)
    , tdBg :: (Maybe String)
    } deriving (Eq,Show)
...
data Th = Th Th_Attrs String
        deriving (Eq,Show)
data Th_Attrs = Th_Attrs
    { thColno :: (Maybe String)
    , thColspan :: (Maybe String)
    , thRowspan :: (Maybe String)
    , thClass :: (Maybe String)
    , thBitwidth :: (Maybe String)
    } deriving (Eq,Show)

newtype Title = Title [Title_] 		deriving (Eq,Show)
...
data Toptitle = Toptitle
    { toptitleInstructionset :: String
    } deriving (Eq,Show)

data Tr = TrTh Tr_Attrs (List1 Th)
        | TrTd Tr_Attrs (List1 Td)
        deriving (Eq,Show)
data Tr_Attrs = Tr_Attrs
    { trClass :: (Maybe String)
    , trIclass :: (Maybe String)
    , trId :: (Maybe String)
    , trEncname :: (Maybe String)
    , trFirst :: (Maybe String)
    , trLast :: (Maybe String)
    , trIformfile :: (Maybe String)
    , trOneofthismnem :: (Maybe String)
    , trLabel :: (Maybe String)
    , trUndef :: (Maybe Tr_undef)
    , trGroupid :: (Maybe String)
    } deriving (Eq,Show)
...
data Line_Attrs = Line_Attrs
    { lineIndent :: (Maybe String)
    , lineLink :: (Maybe String)
    , lineFile :: (Maybe String)
    , lineHover :: (Maybe String)
    , lineConts :: (Maybe String)
    } deriving (Eq,Show)
...
instance XmlContent Allinstrs where
    toContents (Allinstrs as a b) =
        [CElem (Elem (N "allinstrs") (toAttrs as) (toContents a ++
                                                   toContents b)) ()]
    parseContents = do
        { e@(Elem _ as _) <- element ["allinstrs"]
        ; interior e $ return (Allinstrs (fromAttrs as))
                       `apply` parseContents `apply` parseContents
        } `adjustErr` ("in <allinstrs>, "++)
instance XmlAttributes Allinstrs_Attrs where
    fromAttrs as =
        Allinstrs_Attrs
          { allinstrsId = definiteA fromAttrToStr "allinstrs" "id" as
          , allinstrsXreflabel = definiteA fromAttrToStr "allinstrs" "xreflabel" as
          }
    toAttrs v = catMaybes 
...
instance XmlContent File where
    ...
    parseContents = do 
        ...
        ; interior e $ oneOf
            ...
            , return (FileInstructionsection (fromAttrs as))
              `apply` parseContents
            , return (FileConstraint_text_mappings (fromAttrs as))
              `apply` parseContents
            ] `adjustErr` ("in <file>, "++)
        }
instance XmlAttributes File_Attrs where
    fromAttrs as =
        File_Attrs
          { fileType = definiteA fromAttrToStr "file" "type" as
          , fileFile = definiteA fromAttrToStr "file" "file" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "type" (fileType v)
        , toAttrFrStr "file" (fileFile v)
        ]
...
instance XmlContent Alphaindex where
    toContents (Alphaindex a b) =
        [CElem (Elem (N "alphaindex") [] (toContents a ++
                                          toContents b)) ()]
    parseContents = do
        { e@(Elem _ [] _) <- element ["alphaindex"]
        ; interior e $ return (Alphaindex) `apply` parseContents
                       `apply` parseContents
...
instance XmlAttributes Asmtemplate_Attrs where
    fromAttrs as =
        Asmtemplate_Attrs
          { asmtemplateClass = possibleA fromAttrToStr "class" as
...
instance XmlAttributes Box_Attrs where
    fromAttrs as =
        Box_Attrs
          { boxHibit = possibleA fromAttrToStr "hibit" as
...
instance XmlAttrType Brief_synth where
    ...
    toAttrFrTyp n Brief_synth_multiple = Just (N n, str2attr "multiple")
...
instance XmlContent Encodingindex where
    toContents (Encodingindex as a b c) =
        [CElem (Elem (N "encodingindex") (toAttrs as) (maybe [] toContents a
                                                       ++ toContents b ++ toContents c)) ()]
    parseContents = do
        { e@(Elem _ as _) <- element ["encodingindex"]
        ; interior e $ return (Encodingindex (fromAttrs as))
                       `apply` optional parseContents `apply` parseContents
                       `apply` parseContents
...
instance XmlAttributes Encodingindex_Attrs where
    fromAttrs as =
        Encodingindex_Attrs
          { encodingindexInstructionset = definiteA fromAttrToStr "encodingindex" "instructionset" as
          }
    toAttrs v = catMaybes 
...
instance XmlContent Groups where
    ...
    parseContents = do
        { e@(Elem _ as _) <- element ["groups"]
        ; interior e $ return (Groups (fromAttrs as)) `apply` parseContents
        } `adjustErr` ("in <groups>, "++)
instance XmlAttributes Groups_Attrs where
    fromAttrs as =
        Groups_Attrs
          { groupsHeading = definiteA fromAttrToStr "groups" "heading" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "heading" (groupsHeading v)
        ]
...
instance XmlContent Funcgroupheader where
    ...
    parseContents = do
        { e@(Elem _ as _) <- element ["funcgroupheader"]
        ; interior e $ return (Funcgroupheader (fromAttrs as))
                       `apply` (text `onFail` return "")
        } `adjustErr` ("in <funcgroupheader>, "++)
instance XmlAttributes Funcgroupheader_Attrs where
    fromAttrs as =
        Funcgroupheader_Attrs
          { funcgroupheaderId = definiteA fromAttrToStr "funcgroupheader" "id" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "id" (funcgroupheaderId v)
        ]
...
instance XmlAttributes Thead_Attrs where
    fromAttrs as =
        Thead_Attrs
          { theadClass = possibleA fromAttrToStr "class" as
          }
    toAttrs v = catMaybes 
        [ maybeToAttr toAttrFrStr "class" (theadClass v)
        ]
...
instance XmlContent Explanation_intro where
    toContents (Explanation_intro as a) =
        [CElem (Elem (N "explanation_intro") (toAttrs as) (concatMap toContents a)) ()]
    parseContents = do
        { e@(Elem _ as _) <- element ["explanation_intro"]
        ; interior e $ return (Explanation_intro (fromAttrs as))
                       `apply` many parseContents
        } `adjustErr` ("in <explanation_intro>, "++)
instance XmlAttributes Explanation_intro_Attrs where
    fromAttrs as =
        Explanation_intro_Attrs
          { explanation_introHeadingsabove = definiteA fromAttrToStr "explanation_intro" "headingsabove" as
          }
    toAttrs v = catMaybes 
...
instance XmlContent Explanations where
    toContents (Explanations as a b) =
        [CElem (Elem (N "explanations") (toAttrs as) (maybe [] toContents a
...
instance XmlAttributes Explanations_Attrs where
    fromAttrs as =
        Explanations_Attrs
          { explanationsScope = definiteA fromAttrToStr "explanations" "scope" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "scope" (explanationsScope v)
        ]
...
instance XmlAttributes Explanation_Attrs where
    fromAttrs as =
        Explanation_Attrs
          { explanationEnclist = possibleA fromAttrToStr "enclist" as
          , explanationSymboldefcount = possibleA fromAttrToStr "symboldefcount" as
          , explanationTags = possibleA fromAttrToStr "tags" as
          }
    toAttrs v = catMaybes 
        [ maybeToAttr toAttrFrStr "enclist" (explanationEnclist v)
        , maybeToAttr toAttrFrStr "symboldefcount" (explanationSymboldefcount v)
...
instance XmlContent Instructiontable where
    toContents (Instructiontable as a b c) =
        [CElem (Elem (N "instructiontable") (toAttrs as) (toContents a ++
                                                          toContents b ++ toContents c)) ()]
    parseContents = do
        { e@(Elem _ as _) <- element ["instructiontable"]
        ; interior e $ return (Instructiontable (fromAttrs as))
...
instance XmlAttributes Instructiontable_Attrs where
    fromAttrs as =
        Instructiontable_Attrs
          { instructiontableCols = definiteA fromAttrToStr "instructiontable" "cols" as
          , instructiontableIclass = definiteA fromAttrToStr "instructiontable" "iclass" as
          }
    toAttrs v = catMaybes 
...
instance XmlContent Iclass_sect where
    toContents (Iclass_sect as a b) =
        [CElem (Elem (N "iclass_sect") (toAttrs as) (toContents a ++
                                                     toContents b)) ()]
    parseContents = do
        { e@(Elem _ as _) <- element ["iclass_sect"]
        ; interior e $ return (Iclass_sect (fromAttrs as))
                       `apply` parseContents `apply` parseContents
        } `adjustErr` ("in <iclass_sect>, "++)
instance XmlAttributes Iclass_sect_Attrs where
    fromAttrs as =
        Iclass_sect_Attrs
          { iclass_sectId = definiteA fromAttrToStr "iclass_sect" "id" as
          , iclass_sectTitle = definiteA fromAttrToStr "iclass_sect" "title" as
          }
    toAttrs v = catMaybes 
...
instance XmlAttributes Iclassintro_Attrs where
    fromAttrs as =
        Iclassintro_Attrs
          { iclassintroCount = definiteA fromAttrToStr "iclassintro" "count" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "count" (iclassintroCount v)
        ]
...
instance XmlContent Iform where
    ...
    parseContents = do
        { e@(Elem _ as _) <- element ["iform"]
        ; interior e $ return (Iform (fromAttrs as))
                       `apply` (text `onFail` return "")
        } `adjustErr` ("in <iform>, "++)
instance XmlAttributes Iform_Attrs where
    fromAttrs as =
        Iform_Attrs
          { iformId = definiteA fromAttrToStr "iform" "id" as
...
instance XmlContent Iforms where
    ...
    parseContents = do
        { e@(Elem _ as _) <- element ["iforms"]
        ; interior e $ return (Iforms (fromAttrs as)) `apply` parseContents
        } `adjustErr` ("in <iforms>, "++)
instance XmlAttributes Iforms_Attrs where
    fromAttrs as =
        Iforms_Attrs
          { iformsTitle = definiteA fromAttrToStr "iforms" "title" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "title" (iformsTitle v)
        ]
...
instance XmlContent Instructionsection where
    toContents (Instructionsection as a b c d e f g h i j) =
        [CElem (Elem (N "instructionsection") (toAttrs as) (maybe [] toContents a
                                                            ++ toContents b ++ toContents c ++
                                                            maybe [] toContents d ++
                                                            maybe [] toContents e ++
...
instance XmlAttributes Instructionsection_Attrs where
    fromAttrs as =
        Instructionsection_Attrs
          ...
          , instructionsectionType = definiteA fromAttrToTyp "instructionsection" "type" as
          }
    toAttrs v = catMaybes 
...
instance XmlAttrType Instructionsection_type where
    fromAttrToTyp n (N n',v)
        | n==n'     = translate (attr2str v)
        | otherwise = Nothing
      where translate "instruction" = Just Instructionsection_type_instruction
            translate "alias" = Just Instructionsection_type_alias
            translate "pseudocode" = Just Instructionsection_type_pseudocode
            translate _ = Nothing
    toAttrFrTyp n Instructionsection_type_instruction = Just (N n, str2attr "instruction")
    toAttrFrTyp n Instructionsection_type_alias = Just (N n, str2attr "alias")
    toAttrFrTyp n Instructionsection_type_pseudocode = Just (N n, str2attr "pseudocode")
...
instance XmlContent Classes where
    ...
    parseContents = do
        ...
        ; interior e $ return (Classes) `apply` parseContents
                       `apply` parseContents
...
instance XmlAttributes Classesintro_Attrs where
    fromAttrs as =
        Classesintro_Attrs
          { classesintroCount = definiteA fromAttrToStr "classesintro" "count" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "count" (classesintroCount v)
        ]
...
instance XmlContent Col where
    toContents as =
        [CElem (Elem (N "col") (toAttrs as) []) ()]
    parseContents = do
        { (Elem _ as []) <- element ["col"]
        ; return (fromAttrs as)
        } `adjustErr` ("in <col>, "++)
instance XmlAttributes Col where
    fromAttrs as =
        Col
          { colBitno = possibleA fromAttrToStr "bitno" as
...
instance XmlContent Maintable where
    toContents (Maintable as a b c) =
        [CElem (Elem (N "maintable") (toAttrs as) (concatMap toContents a
                                                   ++ toContents b ++ toContents c)) ()]
    parseContents = do
        { e@(Elem _ as _) <- element ["maintable"]
        ; interior e $ return (Maintable (fromAttrs as))
...
instance XmlAttributes Maintable_Attrs where
    fromAttrs as =
        Maintable_Attrs
          { maintableSize = possibleA fromAttrToTyp "size" as
...
instance XmlAttrType Maintable_class where
    fromAttrToTyp n (N n',v)
      ...
      where translate "grouptable" = Just Maintable_class_grouptable
            ...
            translate _ = Nothing
    toAttrFrTyp n Maintable_class_grouptable = Just (N n, str2attr "grouptable")
    toAttrFrTyp n Maintable_class_allclasses = Just (N n, str2attr "allclasses")
...
instance XmlContent Maintablesect where
    ...
    parseContents = do
        { (Elem _ as []) <- element ["maintablesect"]
        ; return (fromAttrs as)
        } `adjustErr` ("in <maintablesect>, "++)
instance XmlAttributes Maintablesect where
    fromAttrs as =
        Maintablesect
          { maintablesectSect = definiteA fromAttrToStr "maintablesect" "sect" as
...
instance XmlContent Sect1 where
    ...
    toContents (Sect1Title_Para_File as a) =
        [CElem (Elem (N "sect1") (toAttrs as) (toContents a) ) ()]
    parseContents = do 
        { e@(Elem _ as _) <- element ["sect1"]
        ; interior e $ oneOf
            [ return (Sect1File (fromAttrs as)) `apply` parseContents
            , return (Sect1Title_Para_File (fromAttrs as))
              `apply` parseContents
            ] `adjustErr` ("in <sect1>, "++)
        }
instance XmlAttributes Sect1_Attrs where
    fromAttrs as =
        Sect1_Attrs
          { sect1Id = definiteA fromAttrToStr "sect1" "id" as
          }
    toAttrs v = catMaybes 
        [ toAttrFrStr "id" (sect1Id v)
        ]
...
instance XmlContent Tablebody_ where
    ...
    parseContents = return (Tablebody_) `apply` many parseContents
                    `apply` parseContents
...
instance XmlContent Tableheader where
    ...
    parseContents = do
        { e@(Elem _ [] _) <- element ["tableheader"]
...
instance XmlContent Td where
    ...
    parseContents = do
        { e@(Elem _ as _) <- element ["td"]
        ; interior e $ return (Td (fromAttrs as))
                       `apply` many parseContents
        } `adjustErr` ("in <td>, "++)
instance XmlAttributes Td_Attrs where
    fromAttrs as =
        Td_Attrs
          { tdColspan = possibleA fromAttrToStr "colspan" as
...
instance XmlContent Td_ where
    ...
    parseContents = oneOf
        [ return (Td_Str) `apply` text
        , return (Td_A) `apply` parseContents
        ] `adjustErr` ("in <td>, "++)
...
instance XmlContent Th where
    ...
    parseContents = do
        { e@(Elem _ as _) <- element ["th"]
        ; interior e $ return (Th (fromAttrs as))
                       `apply` (text `onFail` return "")
        } `adjustErr` ("in <th>, "++)
instance XmlAttributes Th_Attrs where
    fromAttrs as =
        Th_Attrs
          { thColno = possibleA fromAttrToStr "colno" as
...
instance XmlContent Toptitle where
    toContents as =
        [CElem (Elem (N "toptitle") (toAttrs as) []) ()]
    parseContents = do
        { (Elem _ as []) <- element ["toptitle"]
        ; return (fromAttrs as)
        } `adjustErr` ("in <toptitle>, "++)
instance XmlAttributes Toptitle where
    fromAttrs as =
        Toptitle
          { toptitleInstructionset = definiteA fromAttrToStr "toptitle" "instructionset" as
          }
    toAttrs v = catMaybes 
...
instance XmlAttributes Tr_Attrs where
    fromAttrs as =
        Tr_Attrs
          { trClass = possibleA fromAttrToStr "class" as
...
instance XmlContent Line where
    ...
    parseContents = do
        ...
        ; interior e $ return (Line (fromAttrs as))
                       `apply` many parseContents
        } `adjustErr` ("in <line>, "++)
instance XmlAttributes Line_Attrs where
    fromAttrs as =
        Line_Attrs
          { lineIndent = possibleA fromAttrToStr "indent" as
