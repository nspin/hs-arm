...
data List_Attrs = List_Attrs{listType :: List_type,
                             listRole :: (Maybe List_role), listLanguage :: (Maybe String)}
                deriving (Eq, Show)

data List_type = List_type_ordered
               | List_type_unordered
               | List_type_var
               | List_type_param
               deriving (Eq, Show)

data List_role = List_role_standard
               | List_role_compressed
               | List_role_break
               | List_role_wide
               deriving (Eq, Show)
...
newtype Content = Content [Content_]
                deriving (Eq, Show)
...
newtype Binarynumber = Binarynumber String
                     deriving (Eq, Show)

newtype Sub = Sub String
            deriving (Eq, Show)

newtype Sup = Sup String
            deriving (Eq, Show)
...
newtype AEnum = AEnum [String]
              deriving (Eq, Show)

newtype Enumvalue = Enumvalue [String]
                  deriving (Eq, Show)

newtype Arm_defined_word = Arm_defined_word String
                         deriving (Eq, Show)

data Register_link = Register_link Register_link_Attrs String
                   deriving (Eq, Show)

data Register_link_Attrs = Register_link_Attrs{register_linkState
                                               :: (Maybe Register_link_state),
                                               register_linkId :: (Maybe String)}
                         deriving (Eq, Show)

data Register_link_state = Register_link_state_AArch64
                         | Register_link_state_AArch32
                         | Register_link_state_ext
                         deriving (Eq, Show)

newtype Instruction = Instruction [String]
                    deriving (Eq, Show)

data Xref = Xref{xrefLinkend :: String,
                 xrefFilename :: (Maybe String), xrefBrowsertext :: String}
          deriving (Eq, Show)

newtype Url = Url [String]
            deriving (Eq, Show)

newtype Entry = Entry [Entry_]
              deriving (Eq, Show)
...
newtype Table = Table (List1 Tgroup)
              deriving (Eq, Show)

data Textsection = Textsection Textsection_Attrs [Para]
                 deriving (Eq, Show)

data Textsection_Attrs = Textsection_Attrs{textsectionTitle ::
                                           String}
                       deriving (Eq, Show)
...
newtype Registers = Registers (List1 Register)
                  deriving (Eq, Show)
...
data Register_Attrs = Register_Attrs{registerIs_register ::
                                     Register_is_register,
...
newtype Reg_short_name = Reg_short_name String
                       deriving (Eq, Show)

newtype Reg_long_name = Reg_long_name String
                      deriving (Eq, Show)
...
data Reg_reset_value_Attrs = Reg_reset_value_Attrs{reg_reset_valueType
                                                   :: (Maybe String)}
                           deriving (Eq, Show)

newtype Reg_reset_limited_to_el = Reg_reset_limited_to_el String
                                deriving (Eq, Show)

newtype Reg_reset_special_text = Reg_reset_special_text [Reg_reset_special_text_]
                               deriving (Eq, Show)
...
newtype Reg_groups = Reg_groups [Reg_group]
                   deriving (Eq, Show)

newtype Reg_group = Reg_group String
                  deriving (Eq, Show)

newtype Reg_documents_other_regs = Reg_documents_other_regs (List1
                                                               Register_link)
                                 deriving (Eq, Show)
...
data Reg_documented_in_Attrs = Reg_documented_in_Attrs{reg_documented_inId
                                                       :: String}
                             deriving (Eq, Show)
...
newtype Reg_array_start = Reg_array_start String
                        deriving (Eq, Show)

newtype Reg_array_end = Reg_array_end String
                      deriving (Eq, Show)
...
data Usage_constraint_set_Attrs = Usage_constraint_set_Attrs{usage_constraint_setName
                                                             :: (Maybe String)}
                                deriving (Eq, Show)
...
data Reg_access_Attrs = Reg_access_Attrs{reg_accessName ::
                                         (Maybe String)}
                      deriving (Eq, Show)
...
newtype Reg_access_level = Reg_access_level String
                         deriving (Eq, Show)

newtype Reg_access_type = Reg_access_type String
                        deriving (Eq, Show)
...
data Reg_address_Attrs = Reg_address_Attrs{reg_addressExternal_access
                                           :: Reg_address_external_access,
                                           reg_addressMem_map_access :: Reg_address_mem_map_access,
                                           reg_addressPower_domain :: String,
                                           reg_addressRegister_startbit ::
                                           (Maybe Reg_address_register_startbit),
                                           reg_addressRegister_endbit ::
                                           (Maybe Reg_address_register_endbit)}
                       deriving (Eq, Show)
...
newtype Reg_component = Reg_component String
                      deriving (Eq, Show)

newtype Reg_frame = Reg_frame String
                  deriving (Eq, Show)

newtype Reg_offset = Reg_offset [Reg_offset_]
                   deriving (Eq, Show)
...
newtype Reg_condition = Reg_condition String
                      deriving (Eq, Show)
...
data Reg_read_instruction_Attrs = Reg_read_instruction_Attrs{reg_read_instructionMnemonic
                                                             :: String}
                                deriving (Eq, Show)
...
data Reg_write_instruction_Attrs = Reg_write_instruction_Attrs{reg_write_instructionMnemonic
                                                               :: String}
                                 deriving (Eq, Show)

newtype Reg_encoding_params = Reg_encoding_params (List1
                                                     Encoding_param)
                            deriving (Eq, Show)
...
newtype Encoding_fieldname = Encoding_fieldname String
                           deriving (Eq, Show)

newtype Encoding_fieldvalue = Encoding_fieldvalue String
                            deriving (Eq, Show)

newtype Reg_encoding_text = Reg_encoding_text [Reg_encoding_text_]
                          deriving (Eq, Show)
...
newtype Reg_mappings = Reg_mappings [Reg_mapping]
                     deriving (Eq, Show)
...
data Mapped_name_Attrs = Mapped_name_Attrs{mapped_nameFilename ::
                                           (Maybe String)}
                       deriving (Eq, Show)

newtype Mapped_type = Mapped_type String
                    deriving (Eq, Show)

newtype Mapped_execution_state = Mapped_execution_state String
                               deriving (Eq, Show)

newtype Mapped_from_startbit = Mapped_from_startbit String
                             deriving (Eq, Show)

newtype Mapped_from_endbit = Mapped_from_endbit String
                           deriving (Eq, Show)

newtype Mapped_to_startbit = Mapped_to_startbit String
                           deriving (Eq, Show)

newtype Mapped_to_endbit = Mapped_to_endbit String
                         deriving (Eq, Show)

newtype Mapped_from_sec_state = Mapped_from_sec_state String
                              deriving (Eq, Show)

newtype Mapped_to_sec_state = Mapped_to_sec_state String
                            deriving (Eq, Show)

newtype Mapped_from_condition = Mapped_from_condition String
                              deriving (Eq, Show)

newtype Mapped_to_condition = Mapped_to_condition String
                            deriving (Eq, Show)

newtype Reg_purpose = Reg_purpose [Purpose_text]
                    deriving (Eq, Show)

newtype Purpose_text = Purpose_text [Purpose_text_]
                     deriving (Eq, Show)
...
newtype Reg_usage_constraints = Reg_usage_constraints [Usage_constraints_text]
                              deriving (Eq, Show)

newtype Reg_reverse_traps_and_enables = Reg_reverse_traps_and_enables [Reverse_trap_or_enable_text]
                                      deriving (Eq, Show)

newtype Usage_constraints_text = Usage_constraints_text [Usage_constraints_text_]
                               deriving (Eq, Show)
...
newtype Reverse_trap_or_enable_text = Reverse_trap_or_enable_text [Reverse_trap_or_enable_text_]
                                    deriving (Eq, Show)
...
newtype Reg_configuration = Reg_configuration [Configuration_text]
                          deriving (Eq, Show)

newtype Configuration_text = Configuration_text [Configuration_text_]
                           deriving (Eq, Show)
...
newtype Reg_banking = Reg_banking [Reg_banking_]
                    deriving (Eq, Show)
...
newtype Reg_attributes = Reg_attributes [Attributes_text]
                       deriving (Eq, Show)

newtype Attributes_text = Attributes_text [Attributes_text_]
                        deriving (Eq, Show)
...
newtype Shared_fields = Shared_fields [Field]
                      deriving (Eq, Show)
...
data Fields_Attrs = Fields_Attrs{fieldsLength :: String}
                  deriving (Eq, Show)

newtype Fields_condition = Fields_condition String
                         deriving (Eq, Show)

newtype Text_before_fields = Text_before_fields [Text_before_fields_]
                           deriving (Eq, Show)
...
newtype Text_after_fields = Text_after_fields [Text_after_fields_]
                          deriving (Eq, Show)
...
data Field_Attrs = Field_Attrs{fieldIs_variable_length ::
                               Field_is_variable_length,
                               fieldHas_partial_fieldset :: Field_has_partial_fieldset,
                               fieldIs_linked_to_partial_fieldset ::
                               Field_is_linked_to_partial_fieldset,
                               fieldIs_access_restriction_possible ::
                               Field_is_access_restriction_possible,
                               fieldId :: String}
                 deriving (Eq, Show)
...
newtype Field_name = Field_name String
                   deriving (Eq, Show)

newtype Field_shortdesc = Field_shortdesc [Field_shortdesc_]
                        deriving (Eq, Show)
...
newtype Field_msb = Field_msb String
                  deriving (Eq, Show)

newtype Field_lsb = Field_lsb String
                  deriving (Eq, Show)
...
data Partial_fieldset_Attrs = Partial_fieldset_Attrs{partial_fieldsetLinked_field_name
                                                     :: String}
                            deriving (Eq, Show)
...
data Linked_value_Attrs = Linked_value_Attrs{linked_valueValue ::
                                             String}
                        deriving (Eq, Show)
...
newtype Field_array_start = Field_array_start String
                          deriving (Eq, Show)

newtype Field_array_end = Field_array_end String
                        deriving (Eq, Show)

newtype Field_array_description = Field_array_description String
                                deriving (Eq, Show)
...
data Field_description_Attrs = Field_description_Attrs{field_descriptionOrder
                                                       :: Field_description_order}
                             deriving (Eq, Show)
...
data Field_description_order = Field_description_order_before
                             | Field_description_order_value
                             | Field_description_order_after
                             deriving (Eq, Show)
...
newtype Field_value_name = Field_value_name String
                         deriving (Eq, Show)
...
newtype Field_value = Field_value String
                    deriving (Eq, Show)

newtype Field_value_description = Field_value_description [Field_value_description_]
                                deriving (Eq, Show)
...
data Field_value_links_to_Attrs = Field_value_links_to_Attrs{field_value_links_toLinked_field_name
                                                             :: String,
                                                             field_value_links_toLinked_field_condition
                                                             :: String}
                                deriving (Eq, Show)
...
data Field_value_applies_to_Attrs = Field_value_applies_to_Attrs{field_value_applies_toApplies_to_all
                                                                 ::
                                                                 Field_value_applies_to_applies_to_all}
                                  deriving (Eq, Show)
...
newtype Field_resets = Field_resets [Field_reset]
                     deriving (Eq, Show)

data Field_reset = Field_reset Field_reset_Attrs
                               (List1
                                  (OneOf4 Field_reset_number Field_reset_other_field
                                     Field_reset_standard_text
                                     Field_reset_special_text))
                 deriving (Eq, Show)

data Field_reset_Attrs = Field_reset_Attrs{field_resetReset_type ::
                                           (Maybe String)}
                       deriving (Eq, Show)

newtype Field_reset_number = Field_reset_number String
                           deriving (Eq, Show)
...
data Field_reset_other_field_regname_Attrs = Field_reset_other_field_regname_Attrs{field_reset_other_field_regnameState
                                                                                   ::
                                                                                   Field_reset_other_field_regname_state}
                                           deriving (Eq, Show)
...
newtype Field_reset_other_field_fieldname = Field_reset_other_field_fieldname String
                                          deriving (Eq, Show)

newtype Field_reset_standard_text = Field_reset_standard_text String
                                  deriving (Eq, Show)

newtype Field_reset_special_text = Field_reset_special_text [Field_reset_special_text_]
                                 deriving (Eq, Show)
...
newtype Field_access = Field_access (List1 Field_access_state)
                     deriving (Eq, Show)
...
newtype Field_access_level = Field_access_level String
                           deriving (Eq, Show)

newtype Field_access_type = Field_access_type String
                          deriving (Eq, Show)
...
data Reg_fieldset_Attrs = Reg_fieldset_Attrs{reg_fieldsetLength ::
                                             String}
                        deriving (Eq, Show)

data Fieldat = Fieldat{fieldatId :: (Maybe String),
                       fieldatMsb :: String, fieldatLsb :: String}
             deriving (Eq, Show)

newtype Timestamp = Timestamp String
                  deriving (Eq, Show)

newtype Reg_variables = Reg_variables (List1 Reg_variable)
                      deriving (Eq, Show)
...
data Reg_variable_Attrs = Reg_variable_Attrs{reg_variableVariable
                                             :: String,
...
newtype Reg_variable_val = Reg_variable_val String
                         deriving (Eq, Show)
...
newtype Access_mechanism = Access_mechanism Access_instructions
                         deriving (Eq, Show)
...
data Defvar_Attrs = Defvar_Attrs{defvarAccessibility_id ::
                                 (Maybe String)}
                  deriving (Eq, Show)
...
data Def_Attrs = Def_Attrs{defAsmname :: String,
                           defAsmvalue :: (Maybe String), defN :: (Maybe String),
                           defV :: (Maybe String)}
               deriving (Eq, Show)
...
data Enc_Attrs = Enc_Attrs{encN :: String, encV :: (Maybe String),
                           encWidth :: (Maybe String), encVarname :: (Maybe String)}
               deriving (Eq, Show)

data Encbits = Encbits Encbits_Attrs [Encvar]
             deriving (Eq, Show)

data Encbits_Attrs = Encbits_Attrs{encbitsV :: (Maybe String),
                                   encbitsMsb :: String, encbitsLsb :: String}
                   deriving (Eq, Show)

data Encvar = Encvar{encvarName :: String, encvarMsb :: String,
                     encvarLsb :: String}
            deriving (Eq, Show)

data Access_instruction = Access_instruction{access_instructionId
                                             :: String}
                        deriving (Eq, Show)

newtype Access_mechanism_text = Access_mechanism_text [Access_mechanism_text_]
                              deriving (Eq, Show)
...
data Access_permissions = Access_permissions (Maybe
                                                Access_controls)
                                             [Access_permission] [Access_permission_text]
                        deriving (Eq, Show)

newtype Access_controls = Access_controls [Control]
                        deriving (Eq, Show)

data Control = Control{controlField :: String,
...
data Access_permission_Attrs = Access_permission_Attrs{access_permissionInstance
                                                       :: String}
                             deriving (Eq, Show)
...
data Access_set_Attrs = Access_set_Attrs{access_setAccessibility_id
                                         :: String}
                      deriving (Eq, Show)

newtype Accessibility = Accessibility (List1 Access)
                      deriving (Eq, Show)
...
data Access_Attrs = Access_Attrs{accessEl :: String,
                                 accessType :: Access_type}
                  deriving (Eq, Show)

data Access_type = Access_type_undef
                 | Access_type_RO
                 | Access_type_WO
                 | Access_type_RW
                 | Access_type_inaccessible
                 | Access_type_impdef
                 | Access_type_register
                 deriving (Eq, Show)
...
data Condition = Condition{conditionField :: String,
                           conditionOp :: (Maybe String), conditionValue :: String}
               deriving (Eq, Show)

data Exception_level_config = Exception_level_config{exception_level_configEl
                                                     :: Exception_level_config_el,
                                                     exception_level_configState ::
                                                     (Maybe Exception_level_config_state),
                                                     exception_level_configHighest_el ::
                                                     (Maybe Exception_level_config_highest_el)}
                            deriving (Eq, Show)

data Exception_level_config_el = Exception_level_config_el_0
                               | Exception_level_config_el_1
                               | Exception_level_config_el_2
...
newtype Access_permission_text = Access_permission_text [Access_permission_text_]
                               deriving (Eq, Show)
...
newtype Trap_conditions = Trap_conditions [When]
                        deriving (Eq, Show)

newtype When = When [When_]
             deriving (Eq, Show)
...
newtype Trap_text = Trap_text [Para]
                  deriving (Eq, Show)

data Trap_data = Trap_data
               deriving (Eq, Show)

newtype Arch_variants = Arch_variants [Arch_variant]
                      deriving (Eq, Show)

data Arch_variant = Arch_variant{arch_variantName :: String}
                  deriving (Eq, Show)
...
instance XmlAttrType List_type where
        ...
        toAttrFrTyp n List_type_unordered
          = Just (N n, str2attr "unordered")
...
instance XmlAttrType List_role where
        ...
        toAttrFrTyp n List_role_compressed
          = Just (N n, str2attr "compressed")
...
instance XmlContent Hexnumber where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["hexnumber"]
...
instance XmlContent Binarynumber where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["binarynumber"]
               interior e $
                 return (Binarynumber) `apply` (text `onFail` return "")
...
instance XmlContent Sub where
        toContents (Sub a) = [CElem (Elem (N "sub") [] (toText a)) ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["sub"]
...
instance XmlContent Sup where
        toContents (Sup a) = [CElem (Elem (N "sup") [] (toText a)) ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["sup"]
...
instance XmlContent B where
        toContents (B a) = [CElem (Elem (N "b") [] (toText a)) ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["b"]
...
instance XmlContent Function where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["function"]
...
instance XmlContent Enumvalue where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["enumvalue"]
...
instance XmlContent Arm_defined_word where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["arm-defined-word"]
               interior e $
                 return (Arm_defined_word) `apply` (text `onFail` return "")
...
instance XmlAttributes Register_link_Attrs where
        fromAttrs as
          = Register_link_Attrs{register_linkState =
                                  possibleA fromAttrToTyp "state" as,
...
instance XmlAttrType Register_link_state where
        fromAttrToTyp n (N n', v)
          ...
          where translate "AArch64" = Just Register_link_state_AArch64
                ...
                translate _ = Nothing
        toAttrFrTyp n Register_link_state_AArch64
          = Just (N n, str2attr "AArch64")
        toAttrFrTyp n Register_link_state_AArch32
...
instance XmlContent Instruction where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["instruction"]
...
instance XmlContent Xref where
        toContents as = [CElem (Elem (N "xref") (toAttrs as) []) ()]
        parseContents
          = do (Elem _ as []) <- element ["xref"]
               return (fromAttrs as)
              `adjustErr` ("in <xref>, " ++)

instance XmlAttributes Xref where
        fromAttrs as
          = Xref{xrefLinkend = definiteA fromAttrToStr "xref" "linkend" as,
...
instance XmlContent Textsection where
        toContents (Textsection as a)
          = [CElem
               (Elem (N "textsection") (toAttrs as) (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["textsection"]
               interior e $
                 return (Textsection (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <textsection>, " ++)

instance XmlAttributes Textsection_Attrs where
        fromAttrs as
          = Textsection_Attrs{textsectionTitle =
                                definiteA fromAttrToStr "textsection" "title" as}
        toAttrs v = catMaybes [toAttrFrStr "title" (textsectionTitle v)]
...
instance XmlContent Register_page where
        toContents (Register_page a b)
          = [CElem
               (Elem (N "register_page") [] (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["register_page"]
               interior e $
                 return (Register_page) `apply` parseContents `apply` parseContents
...
instance XmlContent Registers where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["registers"]
...
instance XmlContent Register where
        toContents (Register as a b c d e f g h i j k l m n o p q r s t u)
          = [CElem
               (Elem (N "register") (toAttrs as)
                  (toContents a ++
                     toContents b ++
                       maybe [] toContents c ++
                         maybe [] toContents d ++
                                           ...
                                           maybe [] toContents m ++
                                             toContents n ++
                                               maybe [] toContents o ++
                                                 maybe [] toContents p ++
                                                   toContents q ++
                                                     concatMap toContents r ++
                                                       maybe [] toContents s ++
                                                         maybe [] toContents t ++
                                                           maybe [] toContents u))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["register"]
               interior e $
                 return (Register (fromAttrs as)) `apply` parseContents `apply`
                   parseContents
...
instance XmlAttributes Register_Attrs where
        fromAttrs as
          = Register_Attrs{registerIs_register =
                             definiteA fromAttrToTyp "register" "is_register" as,
                           registerIs_internal =
                             definiteA fromAttrToTyp "register" "is_internal" as,
                           registerExecution_state =
                             possibleA fromAttrToTyp "execution_state" as,
                           registerIs_banked =
                             definiteA fromAttrToTyp "register" "is_banked" as,
                           registerIs_optional =
                             definiteA fromAttrToTyp "register" "is_optional" as,
                           registerIs_stub_entry =
                             definiteA fromAttrToTyp "register" "is_stub_entry" as}
        toAttrs v
          = catMaybes
              [toAttrFrTyp "is_register" (registerIs_register v),
               toAttrFrTyp "is_internal" (registerIs_internal v),
               maybeToAttr toAttrFrTyp "execution_state"
                 (registerExecution_state v),
...
instance XmlAttrType Register_is_register where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Register_is_register_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Register_is_register_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Register_is_register_False
...
instance XmlAttrType Register_is_internal where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Register_is_internal_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Register_is_internal_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Register_is_internal_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Register_execution_state where
        fromAttrToTyp n (N n', v)
          ...
          where translate "AArch32" = Just Register_execution_state_AArch32
                ...
                translate _ = Nothing
        toAttrFrTyp n Register_execution_state_AArch32
          = Just (N n, str2attr "AArch32")
        toAttrFrTyp n Register_execution_state_AArch64
          = Just (N n, str2attr "AArch64")
...
instance XmlAttrType Register_is_banked where
        ...
        toAttrFrTyp n Register_is_banked_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Register_is_optional where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Register_is_optional_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Register_is_optional_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Register_is_optional_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Register_is_stub_entry where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Register_is_stub_entry_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Register_is_stub_entry_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Register_is_stub_entry_False
          = Just (N n, str2attr "False")
...
instance XmlContent Reg_short_name where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_short_name"]
               interior e $
                 return (Reg_short_name) `apply` (text `onFail` return "")
...
instance XmlContent Reg_long_name where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_long_name"]
               interior e $
                 return (Reg_long_name) `apply` (text `onFail` return "")
...
instance XmlContent Reg_reset_value where
        toContents (Reg_reset_value as a b)
          = [CElem
               (Elem (N "reg_reset_value") (toAttrs as)
                  (concatMap toContents a ++ maybe [] toContents b))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_reset_value"]
               interior e $
                 return (Reg_reset_value (fromAttrs as)) `apply` many parseContents
                   `apply` optional parseContents
              `adjustErr` ("in <reg_reset_value>, " ++)

instance XmlAttributes Reg_reset_value_Attrs where
        fromAttrs as
          = Reg_reset_value_Attrs{reg_reset_valueType =
                                    possibleA fromAttrToStr "type" as}
        toAttrs v
          = catMaybes
...
instance XmlContent Reg_reset_limited_to_el where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_reset_limited_to_el"]
               interior e $
                 return (Reg_reset_limited_to_el) `apply` (text `onFail` return "")
...
instance XmlContent Reg_reset_special_text where
        toContents (Reg_reset_special_text a)
          = [CElem
               (Elem (N "reg_reset_special_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_reset_special_text"]
               interior e $
                 return (Reg_reset_special_text) `apply` many parseContents
...
instance XmlContent Reg_reset_special_text_ where
        ...
        toContents (Reg_reset_special_text_Arm_defined_word a)
          = toContents a
        ...
        parseContents
          = oneOf
              [return (Reg_reset_special_text_Str) `apply` text,
               ...
               return (Reg_reset_special_text_Binarynumber) `apply` parseContents,
...
instance XmlContent Reg_groups where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_groups"]
...
instance XmlContent Reg_group where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_group"]
...
instance XmlContent Reg_documents_other_regs where
        toContents (Reg_documents_other_regs a)
          = [CElem (Elem (N "reg_documents_other_regs") [] (toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_documents_other_regs"]
               interior e $
                 return (Reg_documents_other_regs) `apply` parseContents
...
instance XmlContent Reg_documented_in where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["reg_documented_in"]
               interior e $
                 return (Reg_documented_in (fromAttrs as)) `apply`
                   (text `onFail` return "")
              `adjustErr` ("in <reg_documented_in>, " ++)

instance XmlAttributes Reg_documented_in_Attrs where
        fromAttrs as
          = Reg_documented_in_Attrs{reg_documented_inId =
                                      definiteA fromAttrToStr "reg_documented_in" "id" as}
        toAttrs v = catMaybes [toAttrFrStr "id" (reg_documented_inId v)]
...
instance XmlContent Reg_array where
        toContents (Reg_array a b)
          = [CElem (Elem (N "reg_array") [] (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_array"]
               interior e $
                 return (Reg_array) `apply` parseContents `apply` parseContents
...
instance XmlContent Reg_array_start where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_array_start"]
               interior e $
                 return (Reg_array_start) `apply` (text `onFail` return "")
...
instance XmlContent Reg_array_end where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_array_end"]
               interior e $
                 return (Reg_array_end) `apply` (text `onFail` return "")
...
instance XmlContent Usage_constraint_set where
        toContents (Usage_constraint_set as a)
          = [CElem
               (Elem (N "usage_constraint_set") (toAttrs as)
                  (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["usage_constraint_set"]
               interior e $
                 return (Usage_constraint_set (fromAttrs as)) `apply`
                   many parseContents
              `adjustErr` ("in <usage_constraint_set>, " ++)

instance XmlAttributes Usage_constraint_set_Attrs where
        fromAttrs as
          = Usage_constraint_set_Attrs{usage_constraint_setName =
                                         possibleA fromAttrToStr "name" as}
        toAttrs v
          = catMaybes
...
instance XmlContent Reg_access where
        toContents (Reg_access as a)
          = [CElem
               (Elem (N "reg_access") (toAttrs as) (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_access"]
               interior e $
                 return (Reg_access (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <reg_access>, " ++)

instance XmlAttributes Reg_access_Attrs where
        fromAttrs as
          = Reg_access_Attrs{reg_accessName =
                               possibleA fromAttrToStr "name" as}
        toAttrs v
          = catMaybes [maybeToAttr toAttrFrStr "name" (reg_accessName v)]
...
instance XmlContent Reg_access_state where
        toContents (Reg_access_state a b)
          = [CElem
               (Elem (N "reg_access_state") [] (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_access_state"]
               interior e $
                 return (Reg_access_state) `apply` parseContents `apply`
                   parseContents
...
instance XmlContent Reg_access_level where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_access_level"]
               interior e $
                 return (Reg_access_level) `apply` (text `onFail` return "")
...
instance XmlContent Reg_access_type where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_access_type"]
               interior e $
                 return (Reg_access_type) `apply` (text `onFail` return "")
...
instance XmlContent Reg_address where
        toContents (Reg_address as a b c)
          = [CElem
               (Elem (N "reg_address") (toAttrs as)
                  (toContents a ++ maybe [] toContents b ++ toContents c))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_address"]
               interior e $
                 return (Reg_address (fromAttrs as)) `apply` parseContents `apply`
...
instance XmlAttributes Reg_address_Attrs where
        fromAttrs as
          = Reg_address_Attrs{reg_addressExternal_access =
                                definiteA fromAttrToTyp "reg_address" "external_access" as,
                              reg_addressMem_map_access =
                                definiteA fromAttrToTyp "reg_address" "mem_map_access" as,
                              reg_addressPower_domain =
                                definiteA fromAttrToStr "reg_address" "power_domain" as,
                              reg_addressRegister_startbit =
                                possibleA fromAttrToTyp "register_startbit" as,
                              reg_addressRegister_endbit =
                                possibleA fromAttrToTyp "register_endbit" as}
        toAttrs v
          = catMaybes
              [toAttrFrTyp "external_access" (reg_addressExternal_access v),
               ...
               maybeToAttr toAttrFrTyp "register_startbit"
                 (reg_addressRegister_startbit v),
               maybeToAttr toAttrFrTyp "register_endbit"
                 (reg_addressRegister_endbit v)]
...
instance XmlAttrType Reg_address_external_access where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Reg_address_external_access_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Reg_address_external_access_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Reg_address_external_access_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Reg_address_mem_map_access where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Reg_address_mem_map_access_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Reg_address_mem_map_access_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Reg_address_mem_map_access_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Reg_address_register_startbit where
        fromAttrToTyp n (N n', v)
          ...
          where translate "31" = Just Reg_address_register_startbit_31
                ...
                translate _ = Nothing
        toAttrFrTyp n Reg_address_register_startbit_31
          = Just (N n, str2attr "31")
        toAttrFrTyp n Reg_address_register_startbit_63
          = Just (N n, str2attr "63")
...
instance XmlAttrType Reg_address_register_endbit where
        fromAttrToTyp n (N n', v)
          ...
          where translate "0" = Just Reg_address_register_endbit_0
                ...
                translate _ = Nothing
        toAttrFrTyp n Reg_address_register_endbit_0
          = Just (N n, str2attr "0")
        toAttrFrTyp n Reg_address_register_endbit_32
          = Just (N n, str2attr "32")
...
instance XmlContent Reg_component where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_component"]
               interior e $
                 return (Reg_component) `apply` (text `onFail` return "")
...
instance XmlContent Reg_frame where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_frame"]
...
instance XmlContent Reg_offset where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_offset"]
        ...
        toContents (Reg_encoding a b c d e)
          = [CElem
               (Elem (N "reg_encoding") []
                  (maybe [] toContents a ++
                     maybe [] toContents b ++
                       maybe [] toContents c ++ toContents d ++ maybe [] toContents e))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_encoding"]
               interior e $
                 return (Reg_encoding) `apply` optional parseContents `apply`
                   optional parseContents
                   `apply` optional parseContents
                   `apply` parseContents
                   `apply` optional parseContents
...
instance XmlContent Reg_condition where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_condition"]
               interior e $
                 return (Reg_condition) `apply` (text `onFail` return "")
...
instance XmlContent Reg_read_instruction where
        toContents (Reg_read_instruction as a)
          = [CElem (Elem (N "reg_read_instruction") (toAttrs as) (toText a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_read_instruction"]
               interior e $
                 return (Reg_read_instruction (fromAttrs as)) `apply`
                   (text `onFail` return "")
              `adjustErr` ("in <reg_read_instruction>, " ++)

instance XmlAttributes Reg_read_instruction_Attrs where
        fromAttrs as
          = Reg_read_instruction_Attrs{reg_read_instructionMnemonic =
                                         definiteA fromAttrToStr "reg_read_instruction" "mnemonic"
                                           as}
        toAttrs v
          = catMaybes
...
instance XmlContent Reg_write_instruction where
        toContents (Reg_write_instruction as a)
          = [CElem (Elem (N "reg_write_instruction") (toAttrs as) (toText a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_write_instruction"]
               interior e $
                 return (Reg_write_instruction (fromAttrs as)) `apply`
                   (text `onFail` return "")
              `adjustErr` ("in <reg_write_instruction>, " ++)

instance XmlAttributes Reg_write_instruction_Attrs where
        fromAttrs as
          = Reg_write_instruction_Attrs{reg_write_instructionMnemonic =
                                          definiteA fromAttrToStr "reg_write_instruction" "mnemonic"
                                            as}
        toAttrs v
          = catMaybes
...
instance XmlContent Reg_encoding_params where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_encoding_params"]
...
instance XmlContent Encoding_param where
        toContents (Encoding_param a b)
          = [CElem
               (Elem (N "encoding_param") [] (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["encoding_param"]
               interior e $
                 return (Encoding_param) `apply` parseContents `apply` parseContents
...
instance XmlContent Encoding_fieldname where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["encoding_fieldname"]
               interior e $
                 return (Encoding_fieldname) `apply` (text `onFail` return "")
...
instance XmlContent Encoding_fieldvalue where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["encoding_fieldvalue"]
               interior e $
                 return (Encoding_fieldvalue) `apply` (text `onFail` return "")
...
instance XmlContent Reg_encoding_text where
        toContents (Reg_encoding_text a)
          = [CElem (Elem (N "reg_encoding_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_encoding_text"]
               interior e $ return (Reg_encoding_text) `apply` many parseContents
...
instance XmlContent Reg_mappings where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_mappings"]
                           ...
                           maybe [] toContents e ++
                             maybe [] toContents f ++
                               maybe [] toContents g ++
                                 maybe [] toContents h ++
                                   maybe [] toContents i ++
                                     maybe [] toContents j ++ maybe [] toContents k))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_mapping"]
               interior e $
                 return (Reg_mapping) `apply` parseContents `apply` parseContents
                   `apply` parseContents
                   `apply` optional parseContents
                   `apply` optional parseContents
                   `apply` optional parseContents
...
instance XmlContent Mapped_name where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["mapped_name"]
               interior e $
                 return (Mapped_name (fromAttrs as)) `apply`
                   (text `onFail` return "")
              `adjustErr` ("in <mapped_name>, " ++)

instance XmlAttributes Mapped_name_Attrs where
        fromAttrs as
          = Mapped_name_Attrs{mapped_nameFilename =
                                possibleA fromAttrToStr "filename" as}
        toAttrs v
          = catMaybes
...
instance XmlContent Mapped_type where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_type"]
               interior e $ return (Mapped_type) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_execution_state where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_execution_state"]
               interior e $
                 return (Mapped_execution_state) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_from_startbit where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_from_startbit"]
               interior e $
                 return (Mapped_from_startbit) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_from_endbit where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_from_endbit"]
               interior e $
                 return (Mapped_from_endbit) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_to_startbit where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_to_startbit"]
               interior e $
                 return (Mapped_to_startbit) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_to_endbit where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_to_endbit"]
               interior e $
                 return (Mapped_to_endbit) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_from_sec_state where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_from_sec_state"]
               interior e $
                 return (Mapped_from_sec_state) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_to_sec_state where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_to_sec_state"]
               interior e $
                 return (Mapped_to_sec_state) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_from_condition where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_from_condition"]
               interior e $
                 return (Mapped_from_condition) `apply` (text `onFail` return "")
...
instance XmlContent Mapped_to_condition where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["mapped_to_condition"]
               interior e $
                 return (Mapped_to_condition) `apply` (text `onFail` return "")
...
instance XmlContent Reg_purpose where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_purpose"]
...
instance XmlContent Purpose_text where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["purpose_text"]
...
instance XmlContent Reg_usage_constraints where
        toContents (Reg_usage_constraints a)
          = [CElem
               (Elem (N "reg_usage_constraints") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_usage_constraints"]
               interior e $
                 return (Reg_usage_constraints) `apply` many parseContents
...
instance XmlContent Reg_reverse_traps_and_enables where
        toContents (Reg_reverse_traps_and_enables a)
          = [CElem
               (Elem (N "reg_reverse_traps_and_enables") []
                  (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_reverse_traps_and_enables"]
               interior e $
                 return (Reg_reverse_traps_and_enables) `apply` many parseContents
...
instance XmlContent Usage_constraints_text where
        toContents (Usage_constraints_text a)
          = [CElem
               (Elem (N "usage_constraints_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["usage_constraints_text"]
               interior e $
                 return (Usage_constraints_text) `apply` many parseContents
...
instance XmlContent Usage_constraints_text_ where
        ...
        toContents (Usage_constraints_text_Arm_defined_word a)
          = toContents a
        ...
        parseContents
          = oneOf
              [return (Usage_constraints_text_Str) `apply` text,
               ...
               return (Usage_constraints_text_Binarynumber) `apply` parseContents,
...
instance XmlContent Reverse_trap_or_enable_text where
        toContents (Reverse_trap_or_enable_text a)
          = [CElem
               (Elem (N "reverse_trap_or_enable_text") []
                  (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reverse_trap_or_enable_text"]
               interior e $
                 return (Reverse_trap_or_enable_text) `apply` many parseContents
...
instance XmlContent Reverse_trap_or_enable_text_ where
        ...
        toContents (Reverse_trap_or_enable_text_Register_link a)
          = toContents a
        toContents (Reverse_trap_or_enable_text_Instruction a)
          = toContents a
        toContents (Reverse_trap_or_enable_text_Xref a) = toContents a
        toContents (Reverse_trap_or_enable_text_Arm_defined_word a)
          = toContents a
        ...
        toContents (Reverse_trap_or_enable_text_Binarynumber a)
          = toContents a
        ...
        parseContents
          = oneOf
              [return (Reverse_trap_or_enable_text_Str) `apply` text,
               ...
               return (Reverse_trap_or_enable_text_Listitem) `apply`
                 parseContents,
               return (Reverse_trap_or_enable_text_Content) `apply` parseContents,
               return (Reverse_trap_or_enable_text_Table) `apply` parseContents,
               return (Reverse_trap_or_enable_text_Note) `apply` parseContents,
               return (Reverse_trap_or_enable_text_Register_link) `apply`
                 parseContents,
               return (Reverse_trap_or_enable_text_Instruction) `apply`
                 parseContents,
               return (Reverse_trap_or_enable_text_Xref) `apply` parseContents,
               return (Reverse_trap_or_enable_text_Arm_defined_word) `apply`
                 parseContents,
               ...
               return (Reverse_trap_or_enable_text_Binarynumber) `apply`
                 parseContents,
               return (Reverse_trap_or_enable_text_Hexnumber) `apply`
                 parseContents,
               ...
               return (Reverse_trap_or_enable_text_Function) `apply`
                 parseContents,
               return (Reverse_trap_or_enable_text_AEnum) `apply` parseContents,
               return (Reverse_trap_or_enable_text_Enumvalue) `apply`
                 parseContents,
...
instance XmlContent Reg_configuration where
        toContents (Reg_configuration a)
          = [CElem (Elem (N "reg_configuration") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_configuration"]
               interior e $ return (Reg_configuration) `apply` many parseContents
...
instance XmlContent Configuration_text where
        toContents (Configuration_text a)
          = [CElem
               (Elem (N "configuration_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["configuration_text"]
               interior e $ return (Configuration_text) `apply` many parseContents
        ...
        parseContents
          = oneOf
              [return (Configuration_text_Str) `apply` text,
               ...
               return (Configuration_text_Arm_defined_word) `apply` parseContents,
...
instance XmlContent Reg_banking where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_banking"]
...
instance XmlContent Reg_attributes where
        toContents (Reg_attributes a)
          = [CElem (Elem (N "reg_attributes") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_attributes"]
...
instance XmlContent Attributes_text where
        toContents (Attributes_text a)
          = [CElem (Elem (N "attributes_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["attributes_text"]
...
instance XmlContent Reg_fieldsets where
        toContents (Reg_fieldsets a b c)
          = [CElem
               (Elem (N "reg_fieldsets") []
                  (maybe [] toContents a ++
                     concatMap toContents b ++ concatMap toContents c))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_fieldsets"]
               interior e $
                 return (Reg_fieldsets) `apply` optional parseContents `apply`
                   many parseContents
                   `apply` many parseContents
...
instance XmlContent Shared_fields where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["shared_fields"]
...
instance XmlContent Fields where
        toContents (Fields as a b c d)
          = [CElem
               (Elem (N "fields") (toAttrs as)
                  (maybe [] toContents a ++
                     maybe [] toContents b ++ toContents c ++ maybe [] toContents d))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["fields"]
               interior e $
                 return (Fields (fromAttrs as)) `apply` optional parseContents
                   `apply` optional parseContents
                   `apply` parseContents
                   `apply` optional parseContents
              `adjustErr` ("in <fields>, " ++)
...
instance XmlAttributes Fields_Attrs where
        fromAttrs as
          = Fields_Attrs{fieldsLength =
                           definiteA fromAttrToStr "fields" "length" as}
        toAttrs v = catMaybes [toAttrFrStr "length" (fieldsLength v)]
...
instance XmlContent Fields_condition where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["fields_condition"]
               interior e $
                 return (Fields_condition) `apply` (text `onFail` return "")
...
instance XmlContent Text_before_fields where
        toContents (Text_before_fields a)
          = [CElem
               (Elem (N "text_before_fields") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["text_before_fields"]
               interior e $ return (Text_before_fields) `apply` many parseContents
        ...
        parseContents
          = oneOf
              [return (Text_before_fields_Str) `apply` text,
               ...
               return (Text_before_fields_Arm_defined_word) `apply` parseContents,
...
instance XmlContent Text_after_fields where
        toContents (Text_after_fields a)
          = [CElem (Elem (N "text_after_fields") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["text_after_fields"]
               interior e $ return (Text_after_fields) `apply` many parseContents
...
instance XmlContent Field where
        toContents (Field as a b c d e f g h i j k l)
          = [CElem
               ...
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["field"]
               interior e $
                 return (Field (fromAttrs as)) `apply` optional parseContents
                   `apply` optional parseContents
                   `apply` parseContents
                   `apply` parseContents
                   `apply` optional parseContents
...
instance XmlAttributes Field_Attrs where
        fromAttrs as
          = Field_Attrs{fieldIs_variable_length =
                          definiteA fromAttrToTyp "field" "is_variable_length" as,
                        fieldHas_partial_fieldset =
                          definiteA fromAttrToTyp "field" "has_partial_fieldset" as,
                        fieldIs_linked_to_partial_fieldset =
                          definiteA fromAttrToTyp "field" "is_linked_to_partial_fieldset" as,
                        fieldIs_access_restriction_possible =
                          definiteA fromAttrToTyp "field" "is_access_restriction_possible"
                            as,
        ...
        toAttrs v
          = catMaybes
              [toAttrFrTyp "is_variable_length" (fieldIs_variable_length v),
               ...
               toAttrFrTyp "is_linked_to_partial_fieldset"
                 (fieldIs_linked_to_partial_fieldset v),
               toAttrFrTyp "is_access_restriction_possible"
                 (fieldIs_access_restriction_possible v),
...
instance XmlAttrType Field_is_variable_length where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Field_is_variable_length_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Field_is_variable_length_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Field_is_variable_length_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Field_has_partial_fieldset where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True" = Just Field_has_partial_fieldset_True
                ...
                translate _ = Nothing
        toAttrFrTyp n Field_has_partial_fieldset_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Field_has_partial_fieldset_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Field_is_linked_to_partial_fieldset where
        fromAttrToTyp n (N n', v)
          ...
          where translate "True"
                  = Just Field_is_linked_to_partial_fieldset_True
                translate "False" = Just Field_is_linked_to_partial_fieldset_False
                translate _ = Nothing
        toAttrFrTyp n Field_is_linked_to_partial_fieldset_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Field_is_linked_to_partial_fieldset_False
          = Just (N n, str2attr "False")
...
instance XmlAttrType Field_is_access_restriction_possible where
        fromAttrToTyp n (N n', v)
          ...
          | otherwise = Nothing
          where translate "True"
                  = Just Field_is_access_restriction_possible_True
                translate "False" = Just Field_is_access_restriction_possible_False
                translate _ = Nothing
        toAttrFrTyp n Field_is_access_restriction_possible_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Field_is_access_restriction_possible_False
          = Just (N n, str2attr "False")
...
instance XmlContent Field_name where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_name"]
               interior e $ return (Field_name) `apply` (text `onFail` return "")
...
instance XmlContent Field_shortdesc where
        toContents (Field_shortdesc a)
          = [CElem (Elem (N "field_shortdesc") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_shortdesc"]
...
instance XmlContent Field_msb where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_msb"]
...
instance XmlContent Field_lsb where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_lsb"]
...
instance XmlContent Partial_fieldset where
        toContents (Partial_fieldset as a b c)
          = [CElem
               (Elem (N "partial_fieldset") (toAttrs as)
                  (toContents a ++ toContents b ++ toContents c))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["partial_fieldset"]
               interior e $
                 return (Partial_fieldset (fromAttrs as)) `apply` parseContents
                   `apply` parseContents
                   `apply` parseContents
...
instance XmlAttributes Partial_fieldset_Attrs where
        fromAttrs as
          = Partial_fieldset_Attrs{partial_fieldsetLinked_field_name =
                                     definiteA fromAttrToStr "partial_fieldset" "linked_field_name"
                                       as}
        toAttrs v
          = catMaybes
              [toAttrFrStr "linked_field_name"
                 (partial_fieldsetLinked_field_name v)]
...
instance XmlContent Linked_value where
        toContents (Linked_value as a)
          = [CElem
               (Elem (N "linked_value") (toAttrs as) (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["linked_value"]
               interior e $
                 return (Linked_value (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <linked_value>, " ++)

instance XmlAttributes Linked_value_Attrs where
        fromAttrs as
          = Linked_value_Attrs{linked_valueValue =
                                 definiteA fromAttrToStr "linked_value" "value" as}
        toAttrs v = catMaybes [toAttrFrStr "value" (linked_valueValue v)]
...
instance XmlContent Field_array where
        toContents (Field_array a b c)
          = [CElem
               ...
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_array"]
               interior e $
                 return (Field_array) `apply` parseContents `apply` parseContents
                   `apply` parseContents
...
instance XmlContent Field_array_start where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_array_start"]
               interior e $
                 return (Field_array_start) `apply` (text `onFail` return "")
...
instance XmlContent Field_array_end where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_array_end"]
               interior e $
                 return (Field_array_end) `apply` (text `onFail` return "")
...
instance XmlContent Field_array_description where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_array_description"]
               interior e $
                 return (Field_array_description) `apply` (text `onFail` return "")
...
instance XmlContent Field_description where
        toContents (Field_description as a)
          = [CElem
               (Elem (N "field_description") (toAttrs as)
                  (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["field_description"]
               interior e $
                 return (Field_description (fromAttrs as)) `apply`
                   many parseContents
              `adjustErr` ("in <field_description>, " ++)

instance XmlAttributes Field_description_Attrs where
        fromAttrs as
          = Field_description_Attrs{field_descriptionOrder =
                                      definiteA fromAttrToTyp "field_description" "order" as}
        toAttrs v
          = catMaybes [toAttrFrTyp "order" (field_descriptionOrder v)]
...
instance XmlAttrType Field_description_order where
        fromAttrToTyp n (N n', v)
          ...
          where translate "before" = Just Field_description_order_before
                ...
                translate _ = Nothing
        toAttrFrTyp n Field_description_order_before
          = Just (N n, str2attr "before")
        toAttrFrTyp n Field_description_order_value
          = Just (N n, str2attr "value")
        toAttrFrTyp n Field_description_order_after
          = Just (N n, str2attr "after")
...
instance XmlContent Field_values where
        toContents (Field_values a b)
          = [CElem
               ...
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_values"]
               interior e $
                 return (Field_values) `apply` optional parseContents `apply`
                   many parseContents
...
instance XmlContent Field_value_name where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_value_name"]
               interior e $
                 return (Field_value_name) `apply` (text `onFail` return "")
...
instance XmlContent Field_value_instance where
        toContents (Field_value_instance a b c d)
          = [CElem
               (Elem (N "field_value_instance") []
                  (toContents a ++
                     toContents b ++ maybe [] toContents c ++ maybe [] toContents d))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_value_instance"]
               interior e $
                 return (Field_value_instance) `apply` parseContents `apply`
                   parseContents
                   `apply` optional parseContents
                   `apply` optional parseContents
...
instance XmlContent Field_value where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_value"]
               interior e $ return (Field_value) `apply` (text `onFail` return "")
...
instance XmlContent Field_value_description where
        toContents (Field_value_description a)
          = [CElem
               (Elem (N "field_value_description") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_value_description"]
               interior e $
                 return (Field_value_description) `apply` many parseContents
...
instance XmlContent Field_value_description_ where
        ...
        toContents (Field_value_description_Arm_defined_word a)
          = toContents a
        ...
        parseContents
          = oneOf
              [return (Field_value_description_Str) `apply` text,
               ...
               return (Field_value_description_Register_link) `apply`
                 parseContents,
               return (Field_value_description_Instruction) `apply` parseContents,
               return (Field_value_description_Xref) `apply` parseContents,
               return (Field_value_description_Arm_defined_word) `apply`
                 parseContents,
               ...
               return (Field_value_description_Binarynumber) `apply`
                 parseContents,
...
instance XmlContent Field_value_links_to where
        toContents (Field_value_links_to as a)
          = [CElem (Elem (N "field_value_links_to") (toAttrs as) (toText a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["field_value_links_to"]
               interior e $
                 return (Field_value_links_to (fromAttrs as)) `apply`
                   (text `onFail` return "")
              `adjustErr` ("in <field_value_links_to>, " ++)

instance XmlAttributes Field_value_links_to_Attrs where
        fromAttrs as
          = Field_value_links_to_Attrs{field_value_links_toLinked_field_name
                                         =
                                         definiteA fromAttrToStr "field_value_links_to"
                                           "linked_field_name"
                                           as,
                                       field_value_links_toLinked_field_condition =
                                         definiteA fromAttrToStr "field_value_links_to"
        ...
        toAttrs v
          = catMaybes
              [toAttrFrStr "linked_field_name"
                 (field_value_links_toLinked_field_name v),
               toAttrFrStr "linked_field_condition"
                 (field_value_links_toLinked_field_condition v)]
...
instance XmlContent Field_value_applies_to where
        toContents (Field_value_applies_to as a)
          = [CElem
               (Elem (N "field_value_applies_to") (toAttrs as)
                  (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["field_value_applies_to"]
               interior e $
                 return (Field_value_applies_to (fromAttrs as)) `apply`
                   many parseContents
              `adjustErr` ("in <field_value_applies_to>, " ++)

instance XmlAttributes Field_value_applies_to_Attrs where
        fromAttrs as
          = Field_value_applies_to_Attrs{field_value_applies_toApplies_to_all
                                           =
                                           definiteA fromAttrToTyp "field_value_applies_to"
                                             "applies_to_all"
                                             as}
        toAttrs v
          = catMaybes
              [toAttrFrTyp "applies_to_all"
                 (field_value_applies_toApplies_to_all v)]
...
instance XmlAttrType Field_value_applies_to_applies_to_all where
        fromAttrToTyp n (N n', v)
          ...
          | otherwise = Nothing
          where translate "True"
                  = Just Field_value_applies_to_applies_to_all_True
                translate "False"
                  = Just Field_value_applies_to_applies_to_all_False
                translate _ = Nothing
        toAttrFrTyp n Field_value_applies_to_applies_to_all_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Field_value_applies_to_applies_to_all_False
          = Just (N n, str2attr "False")
...
instance XmlContent Field_resets where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_resets"]
...
instance XmlContent Field_reset where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["field_reset"]
               interior e $
                 return (Field_reset (fromAttrs as)) `apply` parseContents
              `adjustErr` ("in <field_reset>, " ++)

instance XmlAttributes Field_reset_Attrs where
        fromAttrs as
          = Field_reset_Attrs{field_resetReset_type =
                                possibleA fromAttrToStr "reset_type" as}
        toAttrs v
          = catMaybes
...
instance XmlContent Field_reset_number where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_reset_number"]
               interior e $
                 return (Field_reset_number) `apply` (text `onFail` return "")
...
instance XmlContent Field_reset_other_field where
        toContents (Field_reset_other_field a b)
          = [CElem
               (Elem (N "field_reset_other_field") []
                  (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_reset_other_field"]
               interior e $
                 return (Field_reset_other_field) `apply` parseContents `apply`
                   parseContents
...
instance XmlContent Field_reset_other_field_regname where
        toContents (Field_reset_other_field_regname as a)
          = [CElem
               (Elem (N "field_reset_other_field_regname") (toAttrs as)
                  (toText a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["field_reset_other_field_regname"]
               interior e $
                 return (Field_reset_other_field_regname (fromAttrs as)) `apply`
                   (text `onFail` return "")
              `adjustErr` ("in <field_reset_other_field_regname>, " ++)

instance XmlAttributes Field_reset_other_field_regname_Attrs where
        fromAttrs as
          = Field_reset_other_field_regname_Attrs{field_reset_other_field_regnameState
                                                    =
                                                    definiteA fromAttrToTyp
                                                      "field_reset_other_field_regname"
                                                      "state"
                                                      as}
        toAttrs v
          = catMaybes
...
instance XmlAttrType Field_reset_other_field_regname_state where
        fromAttrToTyp n (N n', v)
          ...
          where translate "AArch32"
                  = Just Field_reset_other_field_regname_state_AArch32
                translate "AArch64"
                  = Just Field_reset_other_field_regname_state_AArch64
                translate "ext" = Just Field_reset_other_field_regname_state_ext
                translate _ = Nothing
        toAttrFrTyp n Field_reset_other_field_regname_state_AArch32
          = Just (N n, str2attr "AArch32")
        toAttrFrTyp n Field_reset_other_field_regname_state_AArch64
          = Just (N n, str2attr "AArch64")
        toAttrFrTyp n Field_reset_other_field_regname_state_ext
          = Just (N n, str2attr "ext")
...
instance XmlContent Field_reset_other_field_fieldname where
        toContents (Field_reset_other_field_fieldname a)
          = [CElem
               (Elem (N "field_reset_other_field_fieldname") [] (toText a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element
                                    ["field_reset_other_field_fieldname"]
               interior e $
                 return (Field_reset_other_field_fieldname) `apply`
                   (text `onFail` return "")
...
instance XmlContent Field_reset_standard_text where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_reset_standard_text"]
               interior e $
                 return (Field_reset_standard_text) `apply`
                   (text `onFail` return "")
...
instance XmlContent Field_reset_special_text where
        toContents (Field_reset_special_text a)
          = [CElem
               (Elem (N "field_reset_special_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_reset_special_text"]
               interior e $
                 return (Field_reset_special_text) `apply` many parseContents
        ...
        parseContents
          = oneOf
              [return (Field_reset_special_text_Str) `apply` text,
               ...
               return (Field_reset_special_text_Register_link) `apply`
                 parseContents,
               return (Field_reset_special_text_Instruction) `apply`
                 parseContents,
               return (Field_reset_special_text_Xref) `apply` parseContents,
               return (Field_reset_special_text_Arm_defined_word) `apply`
                 parseContents,
               ...
               return (Field_reset_special_text_Binarynumber) `apply`
                 parseContents,
...
instance XmlContent Field_access where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_access"]
...
instance XmlContent Field_access_state where
        toContents (Field_access_state a b)
          = [CElem
               (Elem (N "field_access_state") [] (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["field_access_state"]
               interior e $
                 return (Field_access_state) `apply` parseContents `apply`
                   parseContents
...
instance XmlContent Field_access_level where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_access_level"]
               interior e $
                 return (Field_access_level) `apply` (text `onFail` return "")
...
instance XmlContent Field_access_type where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["field_access_type"]
               interior e $
                 return (Field_access_type) `apply` (text `onFail` return "")
...
instance XmlContent Reg_fieldset where
        toContents (Reg_fieldset as a b c)
          = [CElem
               (Elem (N "reg_fieldset") (toAttrs as)
                  (maybe [] toContents a ++ maybe [] toContents b ++ toContents c))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_fieldset"]
               interior e $
                 return (Reg_fieldset (fromAttrs as)) `apply` optional parseContents
                   `apply` optional parseContents
                   `apply` parseContents
...
instance XmlAttributes Reg_fieldset_Attrs where
        fromAttrs as
          = Reg_fieldset_Attrs{reg_fieldsetLength =
                                 definiteA fromAttrToStr "reg_fieldset" "length" as}
        toAttrs v = catMaybes [toAttrFrStr "length" (reg_fieldsetLength v)]

instance HTypeable Fieldat where
        toHType x = Defined "fieldat" [] []

instance XmlContent Fieldat where
        toContents as = [CElem (Elem (N "fieldat") (toAttrs as) []) ()]
        parseContents
          = do (Elem _ as []) <- element ["fieldat"]
               return (fromAttrs as)
              `adjustErr` ("in <fieldat>, " ++)

instance XmlAttributes Fieldat where
        fromAttrs as
          = Fieldat{fieldatId = possibleA fromAttrToStr "id" as,
        ...
        toAttrs v
          = catMaybes
              [maybeToAttr toAttrFrStr "id" (fieldatId v),
               toAttrFrStr "msb" (fieldatMsb v), toAttrFrStr "lsb" (fieldatLsb v)]
...
instance XmlContent Reg_variables where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_variables"]
...
instance XmlContent Reg_variable where
        toContents (Reg_variable as a)
          = [CElem
               (Elem (N "reg_variable") (toAttrs as) (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["reg_variable"]
               interior e $
                 return (Reg_variable (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <reg_variable>, " ++)

instance XmlAttributes Reg_variable_Attrs where
        fromAttrs as
          = Reg_variable_Attrs{reg_variableVariable =
                                 definiteA fromAttrToStr "reg_variable" "variable" as,
...
instance XmlContent Reg_variable_val where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["reg_variable_val"]
               interior e $
                 return (Reg_variable_val) `apply` (text `onFail` return "")
...
instance XmlContent Access_mechanisms where
        toContents (Access_mechanisms a b c d)
          = [CElem
               (Elem (N "access_mechanisms") []
                  (toContents a ++
                     maybe [] toContents b ++
                       maybe [] toContents c ++ concatMap toContents d))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_mechanisms"]
               interior e $
                 return (Access_mechanisms) `apply` parseContents `apply`
                   optional parseContents
                   `apply` optional parseContents
                   `apply` many parseContents
...
instance XmlContent Access_mechanism where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["access_mechanism"]
...
instance XmlContent Access_instructions where
        toContents (Access_instructions a b)
          = [CElem
               (Elem (N "access_instructions") [] (toContents a ++ toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_instructions"]
               interior e $
                 return (Access_instructions) `apply` parseContents `apply`
                   parseContents
...
instance XmlContent Defvar where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["defvar"]
               interior e $ return (Defvar (fromAttrs as)) `apply` parseContents
              `adjustErr` ("in <defvar>, " ++)

instance XmlAttributes Defvar_Attrs where
        fromAttrs as
          = Defvar_Attrs{defvarAccessibility_id =
                           possibleA fromAttrToStr "accessibility_id" as}
        toAttrs v
          = catMaybes
              [maybeToAttr toAttrFrStr "accessibility_id"
                 (defvarAccessibility_id v)]
...
instance XmlContent Def where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["def"]
               interior e $ return (Def (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <def>, " ++)

instance XmlAttributes Def_Attrs where
        fromAttrs as
          = Def_Attrs{defAsmname =
                        definiteA fromAttrToStr "def" "asmname" as,
...
instance XmlContent Enc where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["enc"]
               interior e $ return (Enc (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <enc>, " ++)

instance XmlAttributes Enc_Attrs where
        fromAttrs as
          = Enc_Attrs{encN = definiteA fromAttrToStr "enc" "n" as,
                      encV = possibleA fromAttrToStr "v" as,
                      encWidth = possibleA fromAttrToStr "width" as,
                      encVarname = possibleA fromAttrToStr "varname" as}
        toAttrs v
          = catMaybes
              [toAttrFrStr "n" (encN v), maybeToAttr toAttrFrStr "v" (encV v),
...
instance XmlContent Encbits where
        toContents (Encbits as a)
          = [CElem (Elem (N "encbits") (toAttrs as) (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["encbits"]
               interior e $
                 return (Encbits (fromAttrs as)) `apply` many parseContents
              `adjustErr` ("in <encbits>, " ++)

instance XmlAttributes Encbits_Attrs where
        fromAttrs as
          = Encbits_Attrs{encbitsV = possibleA fromAttrToStr "v" as,
        ...
        toAttrs v
          = catMaybes
              [maybeToAttr toAttrFrStr "v" (encbitsV v),
               toAttrFrStr "msb" (encbitsMsb v), toAttrFrStr "lsb" (encbitsLsb v)]

instance HTypeable Encvar where
        toHType x = Defined "encvar" [] []

instance XmlContent Encvar where
        toContents as = [CElem (Elem (N "encvar") (toAttrs as) []) ()]
        parseContents
          = do (Elem _ as []) <- element ["encvar"]
               return (fromAttrs as)
              `adjustErr` ("in <encvar>, " ++)

instance XmlAttributes Encvar where
        fromAttrs as
          = Encvar{encvarName = definiteA fromAttrToStr "encvar" "name" as,
        ...
        toAttrs v
          = catMaybes
              [toAttrFrStr "name" (encvarName v),
               toAttrFrStr "msb" (encvarMsb v), toAttrFrStr "lsb" (encvarLsb v)]
...
instance XmlContent Access_instruction where
        ...
        parseContents
          = do (Elem _ as []) <- element ["access_instruction"]
               return (fromAttrs as)
              `adjustErr` ("in <access_instruction>, " ++)

instance XmlAttributes Access_instruction where
        fromAttrs as
          = Access_instruction{access_instructionId =
                                 definiteA fromAttrToStr "access_instruction" "id" as}
        toAttrs v = catMaybes [toAttrFrStr "id" (access_instructionId v)]
...
instance XmlContent Access_mechanism_text where
        toContents (Access_mechanism_text a)
          = [CElem
               (Elem (N "access_mechanism_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_mechanism_text"]
               interior e $
                 return (Access_mechanism_text) `apply` many parseContents
...
instance XmlContent Access_mechanism_text_ where
        ...
        toContents (Access_mechanism_text_Arm_defined_word a)
          = toContents a
        ...
        parseContents
          = oneOf
              [return (Access_mechanism_text_Str) `apply` text,
               ...
               return (Access_mechanism_text_Register_link) `apply` parseContents,
               return (Access_mechanism_text_Instruction) `apply` parseContents,
               return (Access_mechanism_text_Xref) `apply` parseContents,
               return (Access_mechanism_text_Arm_defined_word) `apply`
                 parseContents,
...
instance XmlContent Access_permissions where
        toContents (Access_permissions a b c)
          = [CElem
               (Elem (N "access_permissions") []
                  (maybe [] toContents a ++
                     concatMap toContents b ++ concatMap toContents c))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_permissions"]
               interior e $
                 return (Access_permissions) `apply` optional parseContents `apply`
                   many parseContents
                   `apply` many parseContents
...
instance XmlContent Access_controls where
        toContents (Access_controls a)
          = [CElem (Elem (N "access_controls") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_controls"]
...
instance XmlContent Control where
        toContents as = [CElem (Elem (N "control") (toAttrs as) []) ()]
        parseContents
          = do (Elem _ as []) <- element ["control"]
               return (fromAttrs as)
...
instance XmlAttributes Control where
        fromAttrs as
          = Control{controlField =
                      definiteA fromAttrToStr "control" "field" as,
                    controlAarch64_register =
                      possibleA fromAttrToStr "aarch64_register" as,
                    controlAarch32_register =
                      possibleA fromAttrToStr "aarch32_register" as}
        toAttrs v
          = catMaybes
              [toAttrFrStr "field" (controlField v),
               maybeToAttr toAttrFrStr "aarch64_register"
                 (controlAarch64_register v),
               maybeToAttr toAttrFrStr "aarch32_register"
                 (controlAarch32_register v)]
...
instance XmlContent Access_permission where
        toContents (Access_permission as a)
          = [CElem (Elem (N "access_permission") (toAttrs as) (toContents a))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["access_permission"]
               interior e $
                 return (Access_permission (fromAttrs as)) `apply` parseContents
              `adjustErr` ("in <access_permission>, " ++)

instance XmlAttributes Access_permission_Attrs where
        fromAttrs as
          = Access_permission_Attrs{access_permissionInstance =
                                      definiteA fromAttrToStr "access_permission" "instance" as}
        toAttrs v
          = catMaybes [toAttrFrStr "instance" (access_permissionInstance v)]
...
instance XmlContent Access_set where
        ...
        parseContents
          = do e@(Elem _ as _) <- element ["access_set"]
               interior e $
                 return (Access_set (fromAttrs as)) `apply` parseContents
              `adjustErr` ("in <access_set>, " ++)

instance XmlAttributes Access_set_Attrs where
        fromAttrs as
          = Access_set_Attrs{access_setAccessibility_id =
                               definiteA fromAttrToStr "access_set" "accessibility_id" as}
        toAttrs v
          = catMaybes
...
instance XmlContent Accessibility where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["accessibility"]
...
instance XmlContent Access where
        toContents (Access as a b)
          = [CElem
               (Elem (N "access") (toAttrs as)
                  (concatMap toContents a ++ maybe [] toContents b))
               ()]
        parseContents
          = do e@(Elem _ as _) <- element ["access"]
               interior e $
                 return (Access (fromAttrs as)) `apply` many parseContents `apply`
                   optional parseContents
              `adjustErr` ("in <access>, " ++)

instance XmlAttributes Access_Attrs where
        fromAttrs as
          = Access_Attrs{accessEl = definiteA fromAttrToStr "access" "el" as,
                         accessType = definiteA fromAttrToTyp "access" "type" as}
        toAttrs v
          = catMaybes
              [toAttrFrStr "el" (accessEl v), toAttrFrTyp "type" (accessType v)]
...
instance XmlAttrType Access_type where
        ...
        toAttrFrTyp n Access_type_inaccessible
          = Just (N n, str2attr "inaccessible")
        toAttrFrTyp n Access_type_impdef = Just (N n, str2attr "impdef")
        toAttrFrTyp n Access_type_register
          = Just (N n, str2attr "register")
...
instance XmlContent Access_conditions where
        toContents (Access_conditions a b)
          = [CElem
               (Elem (N "access_conditions") []
                  (concatMap toContents a ++ concatMap toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_conditions"]
               interior e $
                 return (Access_conditions) `apply` many parseContents `apply`
                   many parseContents
...
instance XmlContent Condition where
        toContents as = [CElem (Elem (N "condition") (toAttrs as) []) ()]
        parseContents
          = do (Elem _ as []) <- element ["condition"]
               return (fromAttrs as)
...
instance XmlAttributes Condition where
        fromAttrs as
          = Condition{conditionField =
                        definiteA fromAttrToStr "condition" "field" as,
...
instance XmlContent Exception_level_config where
        ...
        parseContents
          = do (Elem _ as []) <- element ["exception_level_config"]
               return (fromAttrs as)
              `adjustErr` ("in <exception_level_config>, " ++)

instance XmlAttributes Exception_level_config where
        fromAttrs as
          = Exception_level_config{exception_level_configEl =
                                     definiteA fromAttrToTyp "exception_level_config" "el" as,
                                   exception_level_configState = possibleA fromAttrToTyp "state" as,
                                   exception_level_configHighest_el =
                                     possibleA fromAttrToTyp "highest_el" as}
        toAttrs v
          = catMaybes
              [toAttrFrTyp "el" (exception_level_configEl v),
               maybeToAttr toAttrFrTyp "state" (exception_level_configState v),
               maybeToAttr toAttrFrTyp "highest_el"
                 (exception_level_configHighest_el v)]
...
instance XmlAttrType Exception_level_config_el where
        fromAttrToTyp n (N n', v)
          ...
          where translate "0" = Just Exception_level_config_el_0
                ...
                translate _ = Nothing
        toAttrFrTyp n Exception_level_config_el_0
          = Just (N n, str2attr "0")
        toAttrFrTyp n Exception_level_config_el_1
          = Just (N n, str2attr "1")
        toAttrFrTyp n Exception_level_config_el_2
          = Just (N n, str2attr "2")
        toAttrFrTyp n Exception_level_config_el_3
          = Just (N n, str2attr "3")
...
instance XmlAttrType Exception_level_config_state where
        fromAttrToTyp n (N n', v)
          | n == n' = translate (attr2str v)
          | otherwise = Nothing
          where translate "unimplemented"
                  = Just Exception_level_config_state_unimplemented
                translate "implemented"
                  = Just Exception_level_config_state_implemented
                translate "AArch32" = Just Exception_level_config_state_AArch32
                translate "AArch64" = Just Exception_level_config_state_AArch64
                translate _ = Nothing
        toAttrFrTyp n Exception_level_config_state_unimplemented
          = Just (N n, str2attr "unimplemented")
        toAttrFrTyp n Exception_level_config_state_implemented
          = Just (N n, str2attr "implemented")
        toAttrFrTyp n Exception_level_config_state_AArch32
          = Just (N n, str2attr "AArch32")
        toAttrFrTyp n Exception_level_config_state_AArch64
          = Just (N n, str2attr "AArch64")
...
instance XmlAttrType Exception_level_config_highest_el where
        fromAttrToTyp n (N n', v)
          ...
          | otherwise = Nothing
          where translate "True"
                  = Just Exception_level_config_highest_el_True
                translate "False" = Just Exception_level_config_highest_el_False
                translate _ = Nothing
        toAttrFrTyp n Exception_level_config_highest_el_True
          = Just (N n, str2attr "True")
        toAttrFrTyp n Exception_level_config_highest_el_False
          = Just (N n, str2attr "False")
...
instance XmlContent Access_permission_text where
        toContents (Access_permission_text a)
          = [CElem
               (Elem (N "access_permission_text") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["access_permission_text"]
               interior e $
                 return (Access_permission_text) `apply` many parseContents
...
instance XmlContent Access_permission_text_ where
        ...
        toContents (Access_permission_text_Arm_defined_word a)
          = toContents a
        ...
        parseContents
          = oneOf
              [return (Access_permission_text_Str) `apply` text,
               ...
               return (Access_permission_text_Binarynumber) `apply` parseContents,
...
instance XmlContent Traps_and_enables where
        toContents (Traps_and_enables a b)
          = [CElem
               (Elem (N "traps_and_enables") []
                  (maybe [] toContents a ++ concatMap toContents b))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["traps_and_enables"]
               interior e $
                 return (Traps_and_enables) `apply` optional parseContents `apply`
                   many parseContents
...
instance XmlContent Trap_conditions where
        toContents (Trap_conditions a)
          = [CElem (Elem (N "trap_conditions") [] (concatMap toContents a))
               ()]
        parseContents
          = do e@(Elem _ [] _) <- element ["trap_conditions"]
...
instance XmlContent Trap where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["trap"]
               interior e $
                 return (Trap) `apply` parseContents `apply` parseContents
              `adjustErr` ("in <trap>, " ++)
...
instance XmlContent Trap_text where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["trap_text"]
...
instance XmlContent Trap_data where
        toContents Trap_data = [CElem (Elem (N "trap_data") [] []) ()]
        parseContents
          = do (Elem _ as []) <- element ["trap_data"]
               return Trap_data
...
instance XmlContent Arch_variants where
        ...
        parseContents
          = do e@(Elem _ [] _) <- element ["arch_variants"]
...
instance XmlContent Arch_variant where
        ...
        parseContents
          = do (Elem _ as []) <- element ["arch_variant"]
               return (fromAttrs as)
              `adjustErr` ("in <arch_variant>, " ++)

instance XmlAttributes Arch_variant where
        fromAttrs as
          = Arch_variant{arch_variantName =
                           definiteA fromAttrToStr "arch_variant" "name" as}
        toAttrs v = catMaybes [toAttrFrStr "name" (arch_variantName v)]